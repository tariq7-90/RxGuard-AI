...
def analyze(o):
    ...
    # Missing-data flags
    if drug in {"enoxaparin", "vancomycin", "gentamicin", "tobramycin"} and weight is None:
        add_finding(
            findings, "MISSING_WEIGHT",
            "MODERATE",
...
cases = {
    "Case 1 — Methotrexate frequency": {
        "drug":"Methotrexate","dose":"15","unit":"mg","route":"PO","frequency":"Once daily",
        "duration":"30 days","indication":"Rheumatoid arthritis","age":"65","weight":"72",
        "egfr":"58","alt":"32","ast":"29","potassium":"4.3","meds":"","allergy":"None"
    },
    "Case 2 — Insulin glargine frequency": {
        "drug":"Insulin glargine","dose":"20","unit":"units","route":"SC","frequency":"TID",
        "duration":"Ongoing","indication":"Type 2 diabetes","age":"61","weight":"92",
        "egfr":"72","alt":"28","ast":"24","potassium":"4.5","meds":"metformin","allergy":"None"
    },
    "Case 3 — Heparin numeric anomaly": {
        "drug":"Unfractionated heparin","dose":"8000","unit":"units","route":"IV","frequency":"Once",
        "duration":"One-time","indication":"Anticoagulation","age":"54","weight":"80",
        "egfr":"75","alt":"30","ast":"27","potassium":"4.1","meds":"","allergy":"None"
    },
    "Case 4 — Decimal notation": {
        "drug":"Warfarin","dose":".5","unit":"mg","route":"PO","frequency":"Once daily",
        "duration":"7 days","indication":"Atrial fibrillation","age":"70","weight":"78",
        "egfr":"60","alt":"25","ast":"22","potassium":"4.2","meds":"","allergy":"None"
    },
    "Case 5 — Renal review": {
        "drug":"Enoxaparin","dose":"40","unit":"mg","route":"SC","frequency":"Once daily",
        "duration":"7 days","indication":"VTE prophylaxis","age":"79","weight":"",
        "egfr":"22","alt":"26","ast":"25","potassium":"4.4","meds":"","allergy":"None"
    },
}
selected = st.sidebar.selectbox("Load a fictional case", ["— Select —"] + list(cases))
defaults = cases.get(selected, {k:"" for k in ["drug","dose","unit","route","frequency","duration","indication","age","weight","egfr","alt","ast","potassium","meds","allergy"]})
...
with st.form("order_form"):
    ...
    meds = c3.text_input("Current medications (comma-separated)", value=defaults["meds"])
